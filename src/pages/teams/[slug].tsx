...
const TeamDetails: NextPage = ({ teamData, playersData, staffData }: any) => {
    ...
    <Header />
        ...
        <Image src={urlFor(background).url()} width={1920} height={1080} alt="background" className='object-none object-center h-64 w-full -z-1 bg-[#EBECE7]' />
				<h1 className='text-5xl font-bold mb-4 tracking-wide text-center uppercase absolute h-full w-full inline-block top-1/2'
